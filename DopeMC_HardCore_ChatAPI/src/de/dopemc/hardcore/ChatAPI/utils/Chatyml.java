...
public class Chatyml {
    ...
    public boolean globalMuted = false;
    public long globalMuteEndTime = 0;
    public final Map<UUID, Long> playerMuteEndTime = new HashMap<>();
    ...
    public void saveConfig(Main instance) {
        if (chatConfig != null) {
